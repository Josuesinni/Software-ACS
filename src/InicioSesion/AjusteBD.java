...
public class AjusteBD extends JDialog {
    ...
    public AjusteBD(boolean modal, String titulo) {
        super(vta, modal);
        pnl = new JPanel();
    ...
    public void initComponents() {
        ...
        pnl.add(lblTitulo);
        JLabel lblTitulo2 = new JLabel("DE BD", JLabel.CENTER);
        ...
        pnl.add(lblTitulo2);
        txtUsuario = new JTextFieldRounded("Cuenta de administrador de BD", 10, getFuente(0, 0, 16));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!nombre.isEmpty() && !pass.isEmpty()) {
                    if (acceso) {
                        ...
                        Ventana.pass=pass;
                        ConexionBD.con=ConexionBD.conectar(Ventana.usuario, Ventana.pass);
                        new Notificacion(0,"Ajuste realizado con exito",false);
                        dispose();
                    } else {
                        if (nombre.equals("ACSSYSTEM")&&pass.equals("CHANGEBD")) {
                            lblTitulo.setText("CAMBIO DE");
                            lblTitulo2.setText("USUARIO Y CONTRASEÑA");
                            txtUsuario.setText("");
                            txtPass.setText("");
                            acceso = true;
                        } else {
